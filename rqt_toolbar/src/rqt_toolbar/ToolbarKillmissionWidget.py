...
class KillMissionWidget(QWidget):
    ...
    def __init__(self):
        ...
        self._mission_switch = rospy.Subscriber('/tobechange', MissionSwitchMsg, self._mission_switch_callback)
        self.mission_received.connect(self._handle_mission_result)

        self.kill_switch = rospy.Subscriber('/tobechange2',PowerSupplyMsg, self._kill_switch_callback)
