...
//------------------------------------------------------------------------------
//
inline Execution *MainWindowController::getCurrentExecution() const {
  return _current_executions[_current_video_frame];
}

//------------------------------------------------------------------------------
//
inline void MainWindowController::setCurrentExecution(Execution *execution) {
  QMap<FocusedFrameController *, Execution *>::iterator it =
...
//------------------------------------------------------------------------------
//
inline FocusedFrameController *MainWindowController::getExecutionFrame(
...
//------------------------------------------------------------------------------
//
inline FocusedFrameController *MainWindowController::getCurrentFrame() const {
  return _current_video_frame;
}

//------------------------------------------------------------------------------
//
inline void MainWindowController::setCurrentFrame(
