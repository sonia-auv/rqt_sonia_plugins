    ...
    fft_enabled_(false)
{
    ...
    psu_subs_ = nh_.subscribe("/provider_can/power_supply_msgs", 10, &CanClient::PsuCallback,this);

    hydrophones_params_subs_ = nh_.subscribe("/provider_can/hydrophones_params", 10, &CanClient::HydrophonesParamsCallback,this);
    hydrophones_msgs_subs_ = nh_.subscribe("/provider_can/hydrophones_msgs", 10, &CanClient::HydrophonesMsgsCallback,this);

    thruster_back_depth_subs_ = nh_.subscribe("/provider_can/thruster_back_depth_msgs", 10, &CanClient::ThrusterBackDCallback,this);
    thruster_front_depth_subs_ = nh_.subscribe("/provider_can/thruster_front_depth_msgs", 10, &CanClient::ThrusterFrontDCallback,this);
    thrusters_back_heading_msgs_subs_ = nh_.subscribe("/provider_can/thruster_back_heading_msgs", 10, &CanClient::ThrusterBackHCallback,this);
    thrusters_front_heading_msgs_subs_ = nh_.subscribe("/provider_can/thruster_front_heading_msgs", 10, &CanClient::ThrusterFrontHCallback,this);
    thrusters_starboard_msgs_subs_ = nh_.subscribe("/provider_can/thruster_starboard_msgs", 10, &CanClient::ThrusterStarCallback,this);
    thrusters_port_msgs_subs_ = nh_.subscribe("/provider_can/thruster_port_msgs", 10, &CanClient::ThrusterPortCallback,this);

    barometer_pressure_subs_ = nh_.subscribe("/provider_can/barometer_fluidpress_msgs", 10, &CanClient::BarometerPressCallback,this);
    barometer_depth_subs_ = nh_.subscribe("/provider_can/barometer_intern_press_msgs", 10, &CanClient::BarometerDepthCallback,this);


    can_service_client_ = nh_.serviceClient<sonia_msgs::SendCanMessage>("/provider_can/send_can_message");

    can_hydros_srv_.request.device_id = can_hydros_srv_.request.DEVICE_ID_sonars;
    can_hydros_srv_.request.unique_id = can_hydros_srv_.request.UNIQUE_ID_SONARS_hydrophones;

    can_hydros_get_params_srv_.request.device_id = can_hydros_srv_.request.DEVICE_ID_sonars;
    can_hydros_get_params_srv_.request.unique_id = can_hydros_srv_.request.UNIQUE_ID_SONARS_hydrophones;
    can_hydros_get_params_srv_.request.method_number = can_hydros_srv_.request.METHOD_HYDRO_get_params;

    thrusters_back_depth_srv_.request.device_id = thrusters_back_depth_srv_.request.DEVICE_ID_actuators;
    thrusters_back_depth_srv_.request.unique_id = thrusters_back_depth_srv_.request.UNIQUE_ID_ACT_back_depth_motor;
    thrusters_back_depth_srv_.request.method_number = thrusters_back_depth_srv_.request.METHOD_MOTOR_set_speed;
    thrusters_front_depth_srv_.request.device_id = thrusters_back_depth_srv_.request.DEVICE_ID_actuators;
    thrusters_front_depth_srv_.request.unique_id = thrusters_back_depth_srv_.request.UNIQUE_ID_ACT_front_depth_motor;
    thrusters_front_depth_srv_.request.method_number = thrusters_back_depth_srv_.request.METHOD_MOTOR_set_speed;
    thrusters_back_heading_srv_.request.device_id = thrusters_back_depth_srv_.request.DEVICE_ID_actuators;
    thrusters_back_heading_srv_.request.unique_id = thrusters_back_depth_srv_.request.UNIQUE_ID_ACT_back_heading_motor;
    thrusters_back_heading_srv_.request.method_number = thrusters_back_depth_srv_.request.METHOD_MOTOR_set_speed;
    thrusters_front_heading_srv_.request.device_id = thrusters_back_depth_srv_.request.DEVICE_ID_actuators;
    thrusters_front_heading_srv_.request.unique_id = thrusters_back_depth_srv_.request.UNIQUE_ID_ACT_front_heading_motor;
    thrusters_front_heading_srv_.request.method_number = thrusters_back_depth_srv_.request.METHOD_MOTOR_set_speed;
    thrusters_star_srv_.request.device_id = thrusters_back_depth_srv_.request.DEVICE_ID_actuators;
    thrusters_star_srv_.request.unique_id = thrusters_back_depth_srv_.request.UNIQUE_ID_ACT_starboard_motor;
    thrusters_star_srv_.request.method_number = thrusters_back_depth_srv_.request.METHOD_MOTOR_set_speed;
    thrusters_port_srv_.request.device_id = thrusters_back_depth_srv_.request.DEVICE_ID_actuators;
    thrusters_port_srv_.request.unique_id = thrusters_back_depth_srv_.request.UNIQUE_ID_ACT_port_motor;
    thrusters_port_srv_.request.method_number = thrusters_back_depth_srv_.request.METHOD_MOTOR_set_speed;

    diver_interface_srv_.request.device_id =  diver_interface_srv_.request.DEVICE_ID_interfaces;
    diver_interface_srv_.request.unique_id =  diver_interface_srv_.request.UNIQUE_ID_INTERFACE_diver;

    led_indicator_srv_.request.device_id = led_indicator_srv_.request.DEVICE_ID_lights;
...
{
    can_hydros_srv_.request.method_number = can_hydros_srv_.request.METHOD_HYDRO_set_pinger_freq;
...
{
    can_hydros_srv_.request.method_number = can_hydros_srv_.request.METHOD_HYDRO_set_gain;
    can_hydros_srv_.request.parameter_value = (float)ui->spinBox_Hydr_Gain->value();
    can_service_client_.call(can_hydros_srv_);
}

void CanClient::on_spinBox_Hydr_Acq_Thrs_editingFinished()
{
    can_hydros_srv_.request.method_number = can_hydros_srv_.request.METHOD_HYDRO_set_acq_threshold;
...
{
    can_hydros_srv_.request.method_number = can_hydros_srv_.request.METHOD_HYDRO_set_sample_count;
    can_hydros_srv_.request.parameter_value = (float)ui->spinBox_Hydr_Samp_Count->value();
    can_service_client_.call(can_hydros_srv_);
}

void CanClient::on_spinBox_Hydr_Acq_Th_Mode_editingFinished()
{
    can_hydros_srv_.request.method_number = can_hydros_srv_.request.METHOD_HYDRO_set_acq_thrs_mode;
    can_hydros_srv_.request.parameter_value = (float)ui->spinBox_Hydr_Acq_Th_Mode->value();
    can_service_client_.call(can_hydros_srv_);
}

void CanClient::on_spinBox_Hydr_Phase_Calc_Alg_editingFinished()
{
    can_hydros_srv_.request.method_number = can_hydros_srv_.request.METHOD_HYDRO_set_phase_calc_alg;
    can_hydros_srv_.request.parameter_value = (float)ui->spinBox_Hydr_Phase_Calc_Alg->value();
    can_service_client_.call(can_hydros_srv_);
}

void CanClient::on_spinBox_Hydr_Preamp_Gain_editingFinished()
{
    can_hydros_srv_.request.method_number = can_hydros_srv_.request.METHOD_HYDRO_set_preamp_gain;
    can_hydros_srv_.request.parameter_value = (float)ui->spinBox_Hydr_Preamp_Gain->value();
    can_service_client_.call(can_hydros_srv_);
}
...
{
    can_hydros_srv_.request.method_number = can_hydros_srv_.request.METHOD_HYDRO_set_fft_prefilter;
    can_hydros_srv_.request.parameter_value = (float)ui->spinBox_Hydr_Fft_Prefilter->value();
    can_service_client_.call(can_hydros_srv_);
}

void CanClient::on_spinBox_Hydr_Fft_Prefilter_T_editingFinished()
{
    can_hydros_srv_.request.method_number = can_hydros_srv_.request.METHOD_HYDRO_set_fft_prefilter_type;
    can_hydros_srv_.request.parameter_value = (float)ui->spinBox_Hydr_Fft_Prefilter_T->value();
    can_service_client_.call(can_hydros_srv_);
}
...
void CanClient::on_spinBox_Hydr_Cont_Fil_Freq_editingFinished()
{
    ...
    can_hydros_srv_.request.parameter_value = (float)ui->spinBox_Hydr_Cont_Fil_Freq->value();
    can_service_client_.call(can_hydros_srv_);
}
...
{
    can_hydros_srv_.request.method_number = can_hydros_srv_.request.METHOD_HYDRO_set_fft_trig_mode;
    can_hydros_srv_.request.parameter_value = (float)ui->spinBox_Hydr_Fft_Trig_Mode->value();
    can_service_client_.call(can_hydros_srv_);
}

void CanClient::on_pushButton_En_Hydros_clicked()
{
    can_hydros_srv_.request.method_number = can_hydros_srv_.request.METHOD_HYDRO_hydro_enable;
    if(!hydros_enabled_){
...
void CanClient::on_pushButton_En_Fft_clicked() {
    can_hydros_srv_.request.method_number = can_hydros_srv_.request.METHOD_HYDRO_fft_enable;
    if(!fft_enabled_){
        can_hydros_srv_.request.parameter_value = 1;
...
void CanClient::on_pushButton_Thruster_Speed_Bd_clicked() {
    thrusters_back_depth_srv_.request.parameter_value = ui->spinBox_Thruster_Back_Depth->value();
...
{
    thrusters_front_depth_srv_.request.parameter_value = ui->spinBox_Thruster_Front_Depth->value();
...
void CanClient::HydrophonesParamsCallback(const sonia_msgs::HydrophonesParams::ConstPtr &msg) {
...
void CanClient::ThrusterBackDCallback(const sonia_msgs::ThrusterMsg::ConstPtr &msg) {
    ui->label_Thruster_Speed_Bd->setNum(msg->speed);
}

void CanClient::ThrusterFrontDCallback(const sonia_msgs::ThrusterMsg::ConstPtr &msg) {
    ui->label_Thruster_Speed_Fd->setNum(msg->speed);
}

void CanClient::ThrusterBackHCallback(const sonia_msgs::ThrusterMsg::ConstPtr &msg) {
    ui->label_Thruster_Speed_Bh->setNum(msg->speed);
}

void CanClient::ThrusterFrontHCallback(const sonia_msgs::ThrusterMsg::ConstPtr &msg) {
    ui->label_Thruster_Speed_Fh->setNum(msg->speed);
}

void CanClient::ThrusterStarCallback(const sonia_msgs::ThrusterMsg::ConstPtr &msg) {
    ui->label_Thruster_Speed_S->setNum(msg->speed);
}

void CanClient::ThrusterPortCallback(const sonia_msgs::ThrusterMsg::ConstPtr &msg) {
    ui->label_Thruster_Speed_P->setNum(msg->speed);
}

void CanClient::BarometerDepthCallback(const sonia_msgs::BarometerMsg::ConstPtr &msg) {
    ui->label_Baro_press_2->setNum((double)msg->depth);
}

void CanClient::BarometerPressCallback(const sensor_msgs::FluidPressure::ConstPtr &msg) {
