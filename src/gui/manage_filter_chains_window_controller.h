...
class ManageFilterChainsWindowController;
}
 ...
 * Multiligne.
 */
class vision_client::ManageFilterChainsWindowController : public QDialog {
  /**
...
//
inline void
vision_client::ManageFilterChainsWindowController::loadFilterChains() {
...
vision_client::ManageFilterChainsWindowController::getCurrentFilterChain()
    const {
