 ...
 * Multiligne.
 */
class vision_client::FocusedFrameController : public QFrame {
  /**
...
//------------------------------------------------------------------------------
//
inline QLineEdit *const &vision_client::FocusedFrameController::getResultLine()
    const {
...
//------------------------------------------------------------------------------
//
inline vision_client::ImageFrame *const &
vision_client::FocusedFrameController::getImageFrame() const {
  return _ui.video_image_frame;
}

//------------------------------------------------------------------------------
//
inline QToolButton *const &
vision_client::FocusedFrameController::getRecordButton() const {
...
//
inline QToolButton *const &
vision_client::FocusedFrameController::getScreenshotButton() const {
  return _ui.video_screenshot_button;
}

//------------------------------------------------------------------------------
//
inline QComboBox *const &vision_client::FocusedFrameController::getComboBox()
    const {
...
//------------------------------------------------------------------------------
//
inline QIcon vision_client::FocusedFrameController::getIconFromTheme(
