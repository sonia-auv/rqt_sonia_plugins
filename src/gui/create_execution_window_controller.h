...
class CreateExecutionWindowController;
}
 ...
 *
 */
class vision_client::CreateExecutionWindowController : public QDialog {
  /**
...
//------------------------------------------------------------------------------
//
inline QString vision_client::CreateExecutionWindowController::getExecution()
    const {
  return _execution;
}
...
//------------------------------------------------------------------------------
//
inline QString vision_client::CreateExecutionWindowController::getFilterChain()
    const {
...
//------------------------------------------------------------------------------
//
inline QString vision_client::CreateExecutionWindowController::getMedia()
    const {
  return _media;
}
