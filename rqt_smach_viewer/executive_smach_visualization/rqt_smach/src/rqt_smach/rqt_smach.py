...
class Smach(Plugin):
    ...
    def _handle_tree_clicked(self):
        ...
        self._widget.ud_path_input.setCurrentIndex(self._widget.ud_path_input.findText(path))
    ...
    def select_cb(self, event):
        ...
        if item:
            ...
            if event.button() == Qt.LeftButton:
                ...
                self._widget.ud_path_input.setCurrentIndex(self._widget.ud_path_input.findText(item.url))
    ...
    def _structure_msg_update(self, msg, server_name):
        ...
        if path in self._containers:
            ...
            for item in container._children:
                if self._widget.ud_path_input.findText(path+"/"+item) == -1:
