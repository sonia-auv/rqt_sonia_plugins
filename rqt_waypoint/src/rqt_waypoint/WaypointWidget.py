...
class WaypointWidget(QMainWindow):
    ...
    def _odom_callback(self, data):
        self.odom_result_received.emit(data.pose.pose.position.x, data.pose.pose.position.y,data.pose.pose.position.z,data.twist.twist.angular.x, data.twist.twist.angular.y,data.twist.twist.angular.z)
